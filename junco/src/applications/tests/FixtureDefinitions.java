...
public class FixtureDefinitions {
	...
	public static final String TOKEN_PRINTER_INPUT_FILENAME     = FIXTURE_DIRECTORY + "coinTest.junco";
	public static final String TOKEN_PRINTER_EXPECTED_FILENAME  = FIXTURE_DIRECTORY + "coinTestTokens.txt";
	
	public static final String AST_INPUT_FILENAME               = FIXTURE_DIRECTORY + "coinTest.junco";
	...
	public static final String SEMANTIC_INPUT_FILENAME          = FIXTURE_DIRECTORY + "coinTest.junco";
