...
public class NegativeAllocationStrategy implements AllocationStrategy {
	...
	public NegativeAllocationStrategy(MemoryAccessMethod accessor, String baseAddress, int startingOffset) {
	...
	public NegativeAllocationStrategy(MemoryAccessMethod accessor,String baseAddress) {
