...
public class MemoryLocation {
	...
	public static final String FRAME_POINTER = RunTime.GLOBAL_FRAME_POINTER;
	public static final String STACK_POINTER = RunTime.GLOBAL_STACK_POINTER;
	...
	public void resetOffset(int size) {
		offset += size;
	}
