...
public class PositiveAllocationStrategy implements AllocationStrategy {
	...
	public PositiveAllocationStrategy(MemoryAccessMethod accessor, String baseAddress, int startingOffset) {
	...
	public PositiveAllocationStrategy(MemoryAccessMethod accessor, String baseAddress) {
